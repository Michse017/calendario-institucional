...
$router->get('api/linea', [ApiController::class, 'linea']);
$router->get('disponibilidad', [DashboardController::class, 'disponibilidad']);
...
$router->post('eventos/cubrimiento', [EventoController::class, 'cubrimiento']);
