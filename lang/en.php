...
return [
    ...
    // ------------------------------- Responsable y cubrimiento (ficha, formulario, historial)
    'Responsable' => 'Lead',
    'Cubrimiento' => 'Coverage',
    'Responsable del evento' => 'Event lead',
    'Quién responde por este evento. Puede ser otra persona del área, no necesariamente quien lo crea.' => 'Who answers for this event. It can be another person from the department, not necessarily whoever creates it.',
    'No hay usuarios en esta área' => 'There are no users in this department',
    '¿Necesita cubrimiento?' => 'Does it need coverage?',
    'Márcalo si hace falta que alguien del área esté presente. Quién va se decide el día del evento.' => 'Tick it if someone from the department has to be present. Who goes is decided on the day of the event.',
    'Sí, pide cubrimiento' => 'Yes, it needs coverage',
    'No' => 'No',
    'Pide cubrimiento' => 'Needs coverage',
    'No pide cubrimiento' => 'No coverage needed',
    'No pide' => 'Not needed',
    'Este evento pide cubrimiento' => 'This event needs coverage',
    'Este evento no pide cubrimiento' => 'This event does not need coverage',
    'Ya pide cubrimiento' => 'Already needs coverage',
    'Marcar que pide cubrimiento' => 'Mark as needing coverage',
    'Marcar que no pide cubrimiento' => 'Mark as not needing coverage',
    'Quién va se decide el día del evento. Queda en el historial.' => 'Who goes is decided on the day of the event. It is recorded in the history.',
    'El evento pide cubrimiento.' => 'The event now needs coverage.',
    'El evento ya no pide cubrimiento.' => 'The event no longer needs coverage.',
    'Elige quién es responsable del evento.' => 'Choose who leads the event.',
    'Esa persona no pertenece al área del evento. Elige a otra como responsable.' => 'That person does not belong to the event\'s department. Choose someone else as lead.',
    'Cualquier responsable' => 'Any lead',
    'cancelado' => 'cancelled',
    // ------------------------------------------ Calendario: filtro de personas y mapa
    'persona' => 'person',
    'personas' => 'people',
    'Añade una o varias. Salen los eventos de los que alguna de ellas es responsable. En el modo «Disponibilidad», los días en blanco son los que tienen libres.' => 'Add one or more. Shows the events any of them leads. In the "Availability" mode, blank days are the ones they have free.',
    'Escribe un nombre y pulsa Enter…' => 'Type a name and press Enter…',
    'Buscar persona' => 'Search person',
    'Quitar a' => 'Remove',
    'Pulsa Retroceso otra vez para quitar a' => 'Press Backspace again to remove',
    'y :n más' => 'and :n more',
    'Sin eventos este año.' => 'No events this year.',
    'Qué pinta el mapa' => 'What the map shows',
    'Todo el evento' => 'Whole event',
    'Pinta todos los días que dura cada evento, no solo el primero.' => 'Paints every day each event lasts, not only the first one.',
    'Solo el inicio' => 'Start only',
    'Pinta únicamente el día en que arranca cada evento.' => 'Paints only the day each event starts.',
    'Disponibilidad' => 'Availability',
    'Cuánta gente está comprometida cada día. Solo cuenta eventos del calendario: no sabe de vacaciones ni de bajas.' => 'How many people are committed each day. Only calendar events count: it knows nothing about holidays or sick leave.',
    'Piden cubrimiento' => 'Need coverage',
    'Días con eventos que piden cubrimiento.' => 'Days with events that need coverage.',
    'Personas comprometidas' => 'People committed',
    'Eventos que piden cubrimiento' => 'Events needing coverage',
    'Días con gente comprometida' => 'Days with people committed',
    'Días con eventos que piden cubrimiento' => 'Days with events needing coverage',
    'en' => 'in',
    'pulsa para resaltarlos' => 'click to highlight them',
    'Resaltar en el mapa todos esos días' => 'Highlight all those days on the map',
    'por día. Haz clic en un día para ver sus eventos y quién responde por ellos.' => 'per day. Click a day to see its events and who is leading them.',
    'Sin eventos este día.' => 'No events on this day.',
    'Ver este día en el calendario' => 'See this day in the calendar',
    'Todos los del día' => 'All of the day',
    'Ir al evento' => 'Go to the event',
    'Haz clic para ver la ficha' => 'Click to open the details',
    'Van:' => 'Going:',
    // ---------------------------------------------------- Calendario: línea de tiempo
    'Línea de tiempo' => 'Timeline',
    'Evento del área' => 'Department event',
    'Nada en este mes con esos filtros.' => 'Nothing this month with those filters.',
    'Nadie activo en esta área.' => 'Nobody active in this department.',
    // ------------------------------------------------------- Dashboard: cubrimiento
    'Quién lidera y en qué semanas se aprieta. Cuentan los eventos que piden cubrimiento, con su responsable.' => 'Who leads and which weeks get tight. Events needing coverage count, with their lead.',
    'Ver la línea de tiempo' => 'See the timeline',
    'Responsables con más eventos que piden cubrimiento' => 'Leads with the most events needing coverage',
    'Cubrimiento por área' => 'Coverage by department',
    'Responsables que más eventos lideran' => 'Leads with the most events',
    'Carga por responsable' => 'Workload per lead',
    'Ver quién está disponible' => 'See who is available',
    'Días' => 'Days',
    'Ningún evento de :anio pide cubrimiento todavía.' => 'No event in :anio needs coverage yet.',
    'Ningún evento de este año pide cubrimiento todavía.' => 'No event this year needs coverage yet.',
    'Personas-día por semana' => 'Person-days per week',
    'Cuánta gente está comprometida cada semana del año, sumando sus días. El pico va en ámbar: es la semana más cargada.' => 'How many people are committed each week of the year, adding up their days. The peak is in amber: the busiest week.',
    'No lo piden' => 'Do not need it',
    'Eventos que lidera' => 'Events led',
    'De ellos, con cubrimiento' => 'Of those, needing coverage',
    'personas-día' => 'person-days',
    'Nadie comprometido este año todavía: marca qué eventos piden cubrimiento.' => 'Nobody committed this year yet: mark which events need coverage.',
    // -------------------------------------------------------------- Disponibilidad
    'Consulta' => 'Lookup',
    'Quién está comprometido (responsable de un evento que pide cubrimiento) y quién disponible en un rango de fechas. Elige a una persona para ver su agenda día a día. Solo cuenta eventos del calendario: no sabe de vacaciones ni de bajas.' => 'Who is committed (leading an event that needs coverage) and who is available in a date range. Pick a person to see their schedule day by day. Only calendar events count: it knows nothing about holidays or sick leave.',
    'Desde' => 'From',
    'Elegir…' => 'Pick…',
    'Elige un rango' => 'Pick a range',
    'días' => 'days',
    '7 días' => '7 days',
    '15 días' => '15 days',
    '30 días' => '30 days',
    ...
    'Ir a otro mes' => 'Jump to another month',
    'Año anterior' => 'Previous year',
    'Año siguiente' => 'Next year',
    'ahora el día de fin' => 'now pick the end day',
    'Todas · escribe un nombre…' => 'Everyone · type a name…',
    'Quitar la persona' => 'Clear the person',
    'Ver' => 'Show',
    ':libres días disponibles de :total · :ocupados comprometidos' => ':libres days available out of :total · :ocupados committed',
    'ir al calendario' => 'open in the calendar',
    'ver en el calendario' => 'open in the calendar',
    'Solo salen los días comprometidos; el resto del rango lo tiene disponible. Señala un día o un evento para ver a qué corresponde.' => 'Only committed days are shown; the rest of the range is free. Hover a day or an event to see what it belongs to.',
    'No tiene ningún evento con cubrimiento en esas fechas: está disponible todo el rango.' => 'No event needing coverage on those dates: available for the whole range.',
    'Comprometidos' => 'Committed',
    'Responsables de eventos que piden cubrimiento en esas fechas. Señala un evento para ver cuándo; pulsa el nombre para ver su agenda.' => 'Leads of events needing coverage on those dates. Hover an event to see when; click the name to see their schedule.',
    'En' => 'In',
    'agenda' => 'schedule',
    'Nadie está comprometido en esas fechas.' => 'Nobody is committed on those dates.',
    'Disponibles' => 'Available',
    'Ojo: esto solo mira el calendario. No sabe de vacaciones, bajas ni de trabajo que no esté aquí.' => 'Note: this only looks at the calendar. It knows nothing about holidays, sick leave or work that is not recorded here.',
    'Ver su agenda en estas fechas' => 'See their schedule on these dates',
    'Todo el mundo está comprometido en esas fechas.' => 'Everyone is committed on those dates.',
    // --------------------------------------------- Meses con mayúscula (Campos::MESES)
    'Enero' => 'January',
    'Febrero' => 'February',
    'Marzo' => 'March',
    'Abril' => 'April',
